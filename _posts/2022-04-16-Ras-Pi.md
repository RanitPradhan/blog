...
<details> 
  ...
  - <B> Install Rasperry Pi OS on your SD card with the Raspberry Pi Imager</B>
  Go to the [website](https://www.raspberrypi.com/software/) and 
  or just type 
  ```sudo apt install rpi-imager``` in your terminal
