...
## Installaton Procedure
  ...
  - <B> Hello! Rasberrypi </B><br>
    ...
    - **GPIO ports** — these allow you to connect electronic components such as LEDs and buttons to Raspberry Pi. <br>
  ...
  - <B>Let's connect your Raspberry Pi</B>
    ...
    - Use a cable to connect the screen to the Raspberry Pi’s HDMI port — use an adapter if necessary. <br>
  ...
  - Your Raspberry Pi then boots up into a graphical desktop. <br>
